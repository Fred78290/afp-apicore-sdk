...
export interface Params {
  ...
  classes?: string[]
  comments?: string[]
  contains_videos?: string[]
  contributors?: string[]
  countries?: string[]
  country_onlys?: string[]
  country_outs?: string[]
  countrycodes?: string[]
  countrynames?: string[]
  creators?: string[]
  depts?: string[]
  entity_companies?: string[]
  entity_departements?: string[]
  entity_events?: string[]
  entity_functions?: string[]
  entity_locations?: string[]
  entity_medias?: string[]
  entity_organisations?: string[]
  entity_persons?: string[]
  entity_regions?: string[]
  entity_templates?: string[]
  entity_themes?: string[]
  entity_works?: string[]
  events?: string[]
  genres?: string[]
  genreids?: string[]
